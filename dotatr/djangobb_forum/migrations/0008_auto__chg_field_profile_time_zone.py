...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.time_zone'
        db.alter_column('djangobb_forum_profile', 'time_zone', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Profile.time_zone'
        db.alter_column('djangobb_forum_profile', 'time_zone', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'djangobb_forum.profile': {
            ...
            'time_zone': ('django.db.models.fields.CharField', [], {'default': "'Europe/Kiev'", 'max_length': '50'}),
