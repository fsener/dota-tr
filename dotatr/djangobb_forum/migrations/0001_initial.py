...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('djangobb_forum_post', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', to=orm[user_orm_label])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[user_orm_label], null=True, blank=True)),
        ...
        db.create_table('djangobb_forum_reputation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reputations_from', to=orm[user_orm_label])),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reputations_to', to=orm[user_orm_label])),
        ...
        db.create_table('djangobb_forum_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('djangobb_forum.fields.AutoOneToOneField')(related_name='forum_profile', unique=True, to=orm[user_orm_label])),
        ...
        db.create_table('djangobb_forum_posttracking', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('djangobb_forum.fields.AutoOneToOneField')(to=orm[user_orm_label], unique=True)),
        ...
        db.create_table('djangobb_forum_report', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reported_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reported_by', to=orm[user_orm_label])),
            ...
            ('zapped_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='zapped_by', null=True, to=orm[user_orm_label])),
        ...
        db.create_table('djangobb_forum_ban', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='ban_users', unique=True, to=orm[user_orm_label])),
